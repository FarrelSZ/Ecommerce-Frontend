    ...
    <template #body>
      <div class="p-4">
        ...
        <div class="mt-6">
          ...
          <p class="text-sm text-black/55 text-center mt-2">Mohon ditunggu, anda akan segera dialihkan...</p>
        </div>
      </div>
    </template>
  </UModal>
...
const isLoading = computed(() => status.value === "pending" || statusProfile.value === "pending");
