<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="87" height="8" viewBox="0 0 87 8" fill="none">
    <rect width="85" height="1" transform="translate(0.660156 3.19922)" fill="black" fill-opacity="0.26" />
    <mask id="path-1-inside-1_30_6097" fill="white">
      <path d="M83.1602 0.160156L86.6957 3.69569L83.1602 7.23123L79.6246 3.69569L83.1602 0.160156Z" />
    </mask>
    <path
