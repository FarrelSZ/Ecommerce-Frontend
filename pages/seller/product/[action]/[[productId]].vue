        ...
        <SellerFormGroup label="Video Produk">
          <div class="flex gap-6 items-center">
            ...
            <div class="text-xs text-black/50">
              ...
              <p>Format: MP4</p>
              <p>
                Catatan: Kamu dapat menampilkan produk saat video sedang diproses. Video akan muncul setelah berhasil
                diproses.
              </p>
            </div>
          </div>
