<template>
  <UContainer class="py-5 flex flex-col gap-6">
    <UCard>
      <div class="cart-header flex items-center text-gray-500 text-sm font-normal">
    ...
    <UCard>
      ...
      <div class="grid grid-cols-1 divide-y">
        <div
          v-for="i in 5"
          :key="`product-${i}`"
          class="cart-product flex items-center text-gray-500 text-sm font-normal py-5"
        >
          <div class="w-[46%]">
            <div class="flex gap-3 text-sm items-center">
              ...
              <p class="line-clamp-2 items-center text-black/85">
                Kaos Game Over Pixelo - T-shirt / Tees Gamer PS Nintendo Game Retro & Kaos 90an
              </p>
              <div class="w-40">
                <p>Variasi:</p>
                <p>Hitam, XXL</p>
